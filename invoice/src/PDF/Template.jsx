...
function PdfTemplate(props) {
    ...
    return (
        <>
            ...
            <ReactPrint trigger={() => <button className='print'>Print</button>} content={() => ref.current} documentTitle={`INVOICE ${props.InvoiceNumber}`} />

            <button className='add' onClick={() => setAirPopup(true)} >Add Product</button>
